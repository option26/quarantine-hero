export default `<table class="module preheader preheader-hide" role="module"
    ...
    <tr>
        <td role="module-content">
            <p>Jetzt mehr potentielle Helfende erreichen!</p>
        </td>
    </tr>
    </tbody>
</table>
<table class="module" role="module" data-type="text"
    ...
    <tr>
        <td style="padding:18px 0px 18px 0px; text-align:inherit; line-height:40px;"
            ...
            bgcolor="">
            <div><h1 style="text-align: inherit">Benötigst Du weiterhin Hilfe?</h1>
                <div></div>
            </div>
        </td>
    </tr>
...
<table class="module" role="module" data-type="code"
    ...
    <tr>
        <td role="module-content" valign="top" height="100%">
            <div style="font-family: inherit; text-align: inherit; line-height: 1.5">Uns ist aufgefallen, dass Deine
                Anfrage leider noch keine Nachrichten erhalten hat.
            </div>
            ...
            <div style="font-family: inherit; text-align: inherit; line-height: 1.5">Das Ziel unserer Plattform ist es,
                ...
                weitere Helfende in Deiner Umgebung auf Dein Gesuch aufmerksam zu machen!
            </div>
            <div style="font-family: inherit; text-align: inherit"><br></div>
            ...
            <div style="font-family: inherit; text-align: inherit; line-height: 1.5">Sobald Dir dann geholfen wurde,
                kannst Du in der <a href="https://quarantaenehelden.org/#/dashboard">Übersicht</a> Dein Gesuch als
                gelöst markieren!
            </div>
            <div style="font-family: inherit; text-align: inherit"><br></div>
