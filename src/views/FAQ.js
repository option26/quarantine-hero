  ...
  return (
    <div className="mb-10 p-4">
      ...
      <p className="font-open-sans">
        Auf der Plattform quarantänehelden.org kommen Menschen zusammen, die sich gegenseitig unterstützen. Hier
        ...
        alle weiteren Details zur Anfrage (was wird benötigt, wann und wo?) klären.
      </p>

      <h2 className="text-xl font-teaser mt-8">Welche Art von Anfragen kann ich stellen?</h2>

      <p className="font-open-sans">
        Prinzipiell können alle Anfragen gestellt werden, bei denen Hilfe von außen benötigt wird. Das kann ein
      ...
      <p className="font-open-sans">
        Handelt es sich bei der Anfrage um einen Einkauf, könnt ihr selbst ausmachen, wie ihr die Bezahlung des
        Einkaufs handhabt. Eine Möglichkeit wäre, das Geld über Paypal zu senden.
      </p>
      ...
      <p className="font-open-sans">
        Deine Anfrage und ein ungefährer Ort sind öffentlich einsehbar. Dein Name und deine Emailadresse sind
        nicht
        einsehbar.
      </p>
      ...
      <p className="font-open-sans">
        Helfende können www.quarantaenehelden.org nach Anfragen in ihrer Nähe suchen. Die ausgewählte Anfrage
        wird
        angeklickt. Über ein Formular geht eine Email an die Person in Quarantäne. Sie erhält so eine Nachricht
        von
        dir und ihr könnt alles weitere verabreden.
      </p>

      <h2 className="text-xl font-teaser mt-8">Was ist bei einer Übergabe z.B. von Einkäufen zu beachten?</h2>

      <p className="font-open-sans">
        Bitte achtet bei einer Übergabe darauf, dass es keinen Kontakt zwischen einer Person in Quarantäne und
        der
      ...
      <p className="font-open-sans">
        Bitte stelle stets deine eigene Sicherheit an erste Stelle und vermeide direkten Kontakt zu Menschen in
        der
        Quarantäne.
      </p>
      ...
      <p className="font-open-sans">
        Wir sind eine Gemeinschaft. Besonders in schwierigen Zeiten müssen wir zusammenhalten. Hilf deiner
        Nachbarschaft in ihrer schwierigen Quarantäne-Situation. Du trägst so auch dazu bei, die Verbreitung
        des
        Virus‘ einzuschränken.
      </p>

      <h2 className="text-xl font-teaser mt-8">Wie weiß ich, dass die Person wirklich in Quarantäne ist?</h2>

      <p className="font-open-sans">
        Unsere Plattform funktioniert nur über die Ehrlichkeit der Nutzenden. Wenn du dir unsicher
        bist, kannst du
        das dem Anfragesteller mitteilen und zum Beispiel ein Attest erfragen.
      </p>
      ...
      <p className="font-open-sans">
        ...
        haben wir dir&nbsp;
        <a href="/assets/aushang.pdf" className="text-secondary hover:underline" download="/assets/aushang.pdf">hier zum Download</a>
        {' '}
        bereitgestellt
      </p>
      ...
      <p className="font-open-sans">
        Wir sind Andy, Florian, Henrike, Jakob, Julia, Keno, Nicolai, Milena, Philipp und Sophie, eine Gruppe von Freunden, die mit diesem
      ...
      <p className="font-open-sans">
        ...
        Wenn Du eine Anfrage beantwortest, wird deine Antwort und deine E-Mail Adresse an den Anfragensteller geschickt.
      </p>
      <Footer />
    </div>
  );
