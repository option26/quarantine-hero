...
(function () {
  ...
  function startConfetti(timeout, min, max) {
    ...
    if (canvas === null) {
      ...
      canvas.setAttribute(
        "style",
        "display:block;pointer-events:none;position:fixed;top:0"
      );
      ...
      window.addEventListener(
        ...
        function () {
          ...
          confetti.maxCount = window.innerWidth < 835 ? 6 : 100;
          confetti.zIndex = window.innerWidth < 835 ? 99999 : 0;
          confetti.speed = window.innerWidth < 835 ? 0 : 2;
          canvas.style.zIndex = confetti.zIndex;
        },
        true
      );
      confetti.maxCount = window.innerWidth < 835 ? 6 : 100;
  ...
  function updateParticles() {
    ...
    var particle;
    waveAngle += 0.01;
    if(particles.length < confetti.maxCount) {
